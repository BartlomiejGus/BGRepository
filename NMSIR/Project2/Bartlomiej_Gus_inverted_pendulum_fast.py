from Bartlomiej_Gus_regulator_rozmyty import *
...
class InvertedPendulum(QtWidgets.QWidget):
    ...
    def __init__(self, M=10, m=5, l=50, x0=0, theta0=0, dx0=0, dtheta0=0, dis_cyc=True, disruption=[0], iw=1000, ih=500, x_max=100, h_min=0, h_max=100, f_name=None):
        ...
        self.F = 0
        self.regulator_rozmyty = Regulator_rozmyty()
    ...
    def paintEvent(self, e):
        ...
        #Wypisz aktualne wartosci dotyczace modelu
        painter.drawText(30,30,"X: " + str(self.x))
        painter.drawText(30,55,"dX: " + str(self.dx))
        painter.drawText(30,80,"Kat: " + str(self.theta))
        painter.drawText(30,105,"dKat: " + str(self.dtheta))
        painter.drawText(30,130,"F: " + str(self.F))
    ...
    def fuzzy_control(self, x, theta, dx, dtheta):
        return self.regulator_rozmyty.foblicz_wyjscie_regulatora(x=x,theta=theta,dx=dx,dtheta=dtheta)
...
if __name__ == '__main__':
    ...
    # else:
    #     ip = InvertedPendulum(x0=90, dx0=0, theta0=0.0, dtheta0=0.1, ih=800, iw=1000, h_min=-80, h_max=80)
    ip = InvertedPendulum(f_name="C:/Users/barte/Desktop/StudiaMGRII/NMSIR/Projekt2/Regulator rozmyty/Warunki początkowe zakłócenia/4.txt")
